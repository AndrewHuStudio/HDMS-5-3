...
async def report_ingestion(request: IngestionReportRequest) -> IngestionReportResponse:
    ...
    for doc_dir in doc_dirs:
        ...
        documents.append(DocumentIngestionState(
            ...
            processed_chunks=int(doc.get("processed_chunks") or 0),
            total_chunks=int(doc.get("total_chunks") or doc.get("chunks_count") or 0),
            progress=int(doc.get("ingest_progress") or (100 if status == "complete" else 0)),
