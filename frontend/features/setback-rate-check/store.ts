...
interface SetbackRateCheckState {
...
export const useSetbackRateCheckStore = create<SetbackRateCheckState>((set) => ({
  ...initialState,
  setResult: (result) => set({ result, selectedPlotName: null }),
